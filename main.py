...
if __name__ == "__main__":
    ...
    agg_prec_df = agg_prec(prec_df, 'secPrecipExpUncert','p')
    agg_thrfall_df = agg_prec(thrfall_df, 'TFPrecipExpUncert','t')

    print(agg_prec_df.count()) # 19
    print(agg_thrfall_df.count()) #14
